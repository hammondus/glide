...
enclosing scope dies, the blocked select unwinds. Chapter 27 covers the
mechanism.
...
payoff of the cancellation design", and Chapter 27 is where the
mechanism lives.
...
normal scope exit would join it forever (Chapter 28's sharpest edge).
