# Chapter 25: Generators

Chapter 24 covered how to *consume* an iterator. This chapter covers
...
are lazy iterators (Chapter 24), an infinite sequence is a perfectly
...
iteration, so `zip` and lockstep consumption become hard (Chapter 24).
...
Restated from Chapter 24 because it is the decision that keeps the
